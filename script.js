...
let disappearAfter = 300; // circles will disappear after n seconds — propotional to trailing length
let appearAfter = 50; // circles with appear after n seconds — inverse to number of dots
